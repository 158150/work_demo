...
class AccountRest(rest.Rest):
    ...
    def sign(self, content):
        ...
        """
        print('签名:',self.privateKey, self.publicKey)
        sign = hmac.new(
...
if __name__ == '__main__':
    ...
    publicKey,privateKey = 'rMH0Bw77EiDj8QkxLZ7VAs3EILCsemht8c1VsRHQEhV8Nt7StWvn63df7rIiKqXS', 'zIJRNJrne1PLLRtxcvP9FcshVcduFLGeroCbwdGCkwfM8viah359EeA8omeAD7XT'
    #publicKey, privateKey = '58RSldAKlVjCzwFG3kIc22GEqgm4pS67zFHyTURnEfxsctCCIOgPVzNGB2gUebyY', 'ZuuBX8vDMyrtMITteI5uWlZC0s5ZfMAWa9vprH1GLcGWm91pB3ktZWrf73V8CuXP'
    ...
    print(task.makeOrder('btc/usdt', 1, price=1, orderType='buy-limit'))
    ...
    '''--------------------------------------------------'''
    #print(time.time())
    # task = DataWss(['sol/busd'], topics=['bidAsk'], rspFunc=rspFunc)
    # while 1:
    #     print(len(dic))
    #     time.sleep(5)
